...
namespace Cretu_Alexandru_Lab2.Data
{
    public class Cretu_Alexandru_Lab2Context : DbContext
    {
        ...
        public DbSet<Cretu_Alexandru_Lab2.Models.Author> Author { get; set; }

        public DbSet<Cretu_Alexandru_Lab2.Models.Member> Member { get; set; }

        public DbSet<Cretu_Alexandru_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
